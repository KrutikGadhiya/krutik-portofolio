...
export default function Skills() {
  ...
  return (
    <section id='skill' class="skills">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#cc6600" fill-opacity="1" d="M0,64L26.7,69.3C53.3,75,107,85,160,80C213.3,75,267,53,320,53.3C373.3,53,427,75,480,85.3C533.3,96,587,96,640,101.3C693.3,107,747,117,800,117.3C853.3,117,907,107,960,90.7C1013.3,75,1067,53,1120,58.7C1173.3,64,1227,96,1280,96C1333.3,96,1387,64,1413,48L1440,32L1440,0L1413.3,0C1386.7,0,1333,0,1280,0C1226.7,0,1173,0,1120,0C1066.7,0,1013,0,960,0C906.7,0,853,0,800,0C746.7,0,693,0,640,0C586.7,0,533,0,480,0C426.7,0,373,0,320,0C266.7,0,213,0,160,0C106.7,0,53,0,27,0L0,0Z"></path></svg>      <h1 className='heading1'>My Skills</h1>
