...
export default function Contact() {
  ...
  return (
    <section id='contact' class="contact">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f0f0f0" fill-opacity="1" d="M0,96L30,90.7C60,85,120,75,180,112C240,149,300,235,360,256C420,277,480,235,540,224C600,213,660,235,720,208C780,181,840,107,900,85.3C960,64,1020,96,1080,138.7C1140,181,1200,235,1260,245.3C1320,256,1380,224,1410,208L1440,192L1440,0L1410,0C1380,0,1320,0,1260,0C1200,0,1140,0,1080,0C1020,0,960,0,900,0C840,0,780,0,720,0C660,0,600,0,540,0C480,0,420,0,360,0C300,0,240,0,180,0C120,0,60,0,30,0L0,0Z"></path></svg>
